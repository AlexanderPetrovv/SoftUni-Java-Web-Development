...
public class ProductServiceImpl implements ProductService {
    ...
    public void saveProduct(ProductServiceModel productServiceModel) {
        // We use Model Mapper to map the ProductServiceModel to Product because our repository uses Product.
        Product product = this.modelMapper.map(productServiceModel, Product.class);
        product.setType(ProductType.valueOf(productServiceModel.getType()));
